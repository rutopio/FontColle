...
def statements_for(r, now):
    ...
    designer_profiles = json.dumps(r.get("designerProfiles", []), ensure_ascii=False)
    cols = (
        ...
        "is_published,popularity_rank,trending_rank,last_modified,version_history,specimen,about,designer_profiles,license_header,tags,"
    ...
    vals = (
        ...
        f"{q(r.get('about'))},{q(designer_profiles)},{q(r.get('licenseHeader'))},"
        f"{q(tags)},"
