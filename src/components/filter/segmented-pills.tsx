      ...
      {items.map(([value, count], i) => {
        ...
        return (
          <button
            ...
            className={cn(
              "relative flex min-h-9 flex-1 items-center justify-between gap-1.5 px-2.5 py-2 text-xs transition-[color,background-color] duration-200 md:min-h-8 md:py-1",
