...
function FacetPickerDialog({
  ...
  description: string;
  searchPlaceholder: string;
  // Which of the pair is the prominent text; the other is the muted caption.
  // Features lead with the tag ("liga"); writing systems/languages lead with
  // the human label ("Latin").
  primary?: "label" | "value";
}) {
